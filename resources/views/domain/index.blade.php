...
{{--            {{ __('lll') }}<br/>--}}
            ...
            @else
                ...
                <div class="text-left" >
                    ...
                    <h1>Наш товар</h1>
                    <p>Продаём услугу наблюдения за доменами, вы оплачиваете наблюдение и сервис следит за доменом, как только он (домен) становится доступен для регистрации, в боте отправляем вам уведомления об этом!</p>
